...
console.log("\n Question 94:");
let words = ["Coding", "TypeScript", "JavaScript", "Programming"]; //creating an array of words
let lengths = words.map(word => word.length); //using .map() method to find the length of each word in an array
console.log(words);
console.log(lengths);
